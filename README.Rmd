...
- `transformed_samples_38.csv`, `transformed_samples_53.5.csv`, `transformed_samples_18.6.csv`
...
These files contain estimates of the annual number of human AIV infections and transformed posterior samples for mean interpandemic periods of 38, 53.5, and 18.6 years. They also contain the results of the sensitivity analyses and mechanistic boundary analysis. 
